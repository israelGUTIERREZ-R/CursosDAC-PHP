<?php
    ...
    if ($user == "" || $password == "") {
        ...
        try {
            $conexion = new PDO('mysql:host=127.0.0.1;dbname=cursosdac;charset=utf8', 'root', '');
            ...
            echo "Se produjo una excepción durante la conexión:" . $ex;
        } catch (Exception $ex) {
            echo "Se produjo una excepción:" . $ex;
        }
    }