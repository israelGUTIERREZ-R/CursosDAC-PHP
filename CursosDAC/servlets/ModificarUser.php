<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        $query = "UPDATE usuario SET NombreUsuario = :nombreUser WHERE password = :contraUser AND rol = :rolUser";
        ...
        $query2 = "UPDATE usuario SET NombreUsuario = :nombreUser WHERE password = :contraUser AND rol = :rolUser";
            ...
            $sessionUser = $_SESSION['User'] = $nombreUser;
    }