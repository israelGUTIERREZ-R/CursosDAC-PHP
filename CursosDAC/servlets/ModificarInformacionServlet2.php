<?php
    ...
    if(isset($_POST['caja1'])&&isset($_POST['BaseDatos'])){
        ...
        if($idCurso!=null&&$idPeriodo!=null){
            $query3 = "UPDATE periodo SET FechaInicio = '" . $fechaInicio . "', FechaFin = '" . $fechaFin . "', Ingresos = '" . $ingresoStr . "', Egresos = '" . $egresoStr . "' WHERE IDCurso = '" . $idCurso . "' AND FechaInicio = '" . $fechaInicio . "' AND NumeroPeriodo='" . $numP . "' AND IDPeriodo='" . $idPeriodo . "';";
