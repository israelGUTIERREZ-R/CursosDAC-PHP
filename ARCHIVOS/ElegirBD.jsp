...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .fondo { /* Esta es la clase que se aplica al input */
                background-color: white !important;
                color: black !important;
                box-shadow: none !important;
            }

            .fondo:focus { /* Elimina la sombra cuando el input está en foco */
                box-shadow: none !important;
                outline: none !important;
            }

            .contra::placeholder { /* Esta es la clase que se aplica al placeholder */
                color: black !important;
            }
        </style>
    </head>
                                    ...
                                    <div class="input-group mb-3 ajust-select fondo">
                                        ...
                                        <select class="custom-select fondo-submenu boton-desplegable letras-boton " id="inputGroupSelect02" method="post" name="combo">
                                            ...
                                            <%
                                                ...
                                                String query = "SHOW databases LIKE '%cursosdac%';";
